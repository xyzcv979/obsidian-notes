...
## Introduction
Dynamic programming (DP) is usually used to solve optimization problems. Only way to get better at DP is to practice.
...
## Techniques
Sometimes you do not need to store whole DP table in memory, the last 2 values or the last 2 rows of the matrix will suffice
